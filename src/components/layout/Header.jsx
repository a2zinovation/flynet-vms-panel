...
        border: '1px solid #e6eef5',
        borderRadius: '8px',
        boxShadow: '0 6px 18px rgba(10,30,50,0.06)',
      },
    },
    // .lang-item styles remain...
...
    },
    ...
    warningIcon: {
        fontSize: '4.5rem',
        color: '#F9A825', // Yellow/Orange color from Figma
    },
    warningTitle: {
        fontWeight: 700,
        fontSize: '1.5rem',
