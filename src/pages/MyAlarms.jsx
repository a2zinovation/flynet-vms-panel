...
import NotificationsActiveIcon from "@mui/icons-material/NotificationsActive"; // Icon for My Alarms
import VisibilityIcon from "@mui/icons-material/Visibility";
import SearchIcon from "@mui/icons-material/Search";

export default function MyAlarms() {
  // --- Styles based on pageStyles.css using the MUI sx prop ---
  const styles = {
    // .page-wrapper
    pageWrapper: {
      padding: "18px 30px",
    ...
    crumb: {
      ...
      color: "#6c7a91",
      textDecoration: "none",
      fontSize: "13px", // Defined by breadcrumb-wrapper, but repeated for clarity
      "&:hover": {
        color: "#0c1b33",
      },
    },
  ...
  return (
    <Box sx={styles.pageWrapper}>
      ...
      <Box sx={styles.breadcrumbWrapper}>
        {/* Crumb: Home */}
        <Typography variant="body2" sx={styles.crumb}>
        ...
        {/* Crumb: My Alarms */}
        <Typography variant="body2" sx={styles.crumb}>
          <NotificationsActiveIcon sx={{ fontSize: 13, mr: 0.5 }} />
          My Alarms
        </Typography>
            ...
            InputProps={{
              endAdornment: (
                <InputAdornment position="end" sx={styles.searchIconAdornment}>
                  {/* Using the standard MUI SearchIcon instead of 🔍 */}
