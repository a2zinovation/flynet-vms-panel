...
import SecurityIcon from "@mui/icons-material/Security"; // Icon for My Patrols
  ...
  return (
    <Box sx={styles.pageWrapper}>
      ...
      <Box sx={styles.breadcrumbWrapper}>
        ...
        {/* Crumb: My Patrols (Linked) */}
        <Link to="/app/patrols" style={{ textDecoration: 'none', color: 'inherit' }}>
          <Box sx={styles.crumb}>
            <SecurityIcon sx={{ fontSize: 13, mr: 0.5 }} />
            My Patrols
          </Box>
        </Link>
